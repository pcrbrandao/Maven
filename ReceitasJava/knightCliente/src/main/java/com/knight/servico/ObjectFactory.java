 ...
 * generated in the com.knight.servico package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListarLivros_QNAME = new QName("http://servico.knight.com/", "listarLivros");
    private final static QName _ListarLivrosResponse_QNAME = new QName("http://servico.knight.com/", "listarLivrosResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.knight.servico
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.knight.com/", name = "listarLivros")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.knight.com/", name = "listarLivrosResponse")
